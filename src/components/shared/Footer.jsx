    ...
    return (
        ...
        >
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-4 pt-2">
                            <a href="#" className="text-white/60 hover:text-[#df6742] transition-colors p-1" aria-label="Facebook">
                                <FaFacebookF className="w-5 h-5" />
                            </a>
                            <a href="#" className="text-white/60 hover:text-[#df6742] transition-colors p-1" aria-label="Twitter">
                                <FaTwitter className="w-5 h-5" />
                            </a>
                            <a href="#" className="text-white/60 hover:text-[#df6742] transition-colors p-1" aria-label="Instagram">
                    ...
                    <div className="space-y-4 md:pl-4">
                        ...
                        <ul className="space-y-2.5 text-sm font-medium">
                            ...
                            <li>
                                <NextLink href="/about" className="text-white/70 hover:text-white transition-colors">
                                    About Us
                                </NextLink>
                            </li>
                        </ul>
                ...
                {/* BOTTOM COMPACT BOTTOM BAR (Copyright Details) */}
